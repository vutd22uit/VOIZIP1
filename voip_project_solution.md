...
; admin pin = 654321, user pin = 123456
conf => 4084,123456,654321
```
...
exten => s,1,NoOp(IVR Tech - ring sequential)
 ; Quay lần lượt cho đến khi có người nhấc
...
[7] Conference     : 3 máy cùng gọi 4084, nhập 123456 -> nghe nhau
...
| 3 | Họp nội bộ (room conference) | ✅ | Ext 4084, pin 123456/654321 |
...
- [ ] **Task 7:** Ghi `README.md` ở root chứa hướng dẫn build
...
- [ ] **Task 8 (sau khi user gửi screenshot):** Chèn screenshot vào `report.md`, convert sang PDF
